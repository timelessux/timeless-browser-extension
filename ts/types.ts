...
export type TAction = {
  fromAmount: string;
  fromChainId: number;
  fromToken: TTokenLifi;
  slippage: number;
  toChainId: number;
  toToken: TTokenLifi;
};

export type TIncludedSteps = {
  action: TAction[];
  integrator: string;
  tool: string;
